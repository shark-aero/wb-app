...
var y_ticks = d3.range(350 * kgToLbs, graph_domain.y_max + 1, 200);
...
function updateFigure() {
    // get weights
    var emptyWeight = parseFloat(inputEmptyWeight.value) / kgToLbs;
    var fuelVolume = parseFloat(inputFuel.value) / literToGalUS;
    var fuelWeight = fuelVolume * 0.72;
    var pilotWeight = parseFloat(inputPilot.value) / kgToLbs;
    var passengerWeight = parseFloat(inputPassenger.value) / kgToLbs;
    var baggageWeight = parseFloat(inputBaggage.value) / kgToLbs;
    ...
    dataEmpty = {
        ...
        y: emptyWeight * kgToLbs
    };

    // console.log(weightTO * kgToLbs);
    // adjust x axis scale
