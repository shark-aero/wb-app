...
var switchBallastPosition = 0;
// labels
var switchBallastFrontLabel = document.getElementById("ballast-front-label")
var switchBallastRearLabel = document.getElementById("ballast-rear-label")

// switch oxygen
// 1 Yes / 0 No
var switchOxygen = document.getElementById("switch-oxygen");
if (localStorage.getItem("Oxygen")) {
    switchOxygenPosition = localStorage.getItem("Oxygen");
    if (switchOxygenPosition == 1) {
        switchOxygen.checked = true;
        var switchOxygenPosition = 1;
    } else {
        switchOxygen.checked = false;
        var switchOxygenPosition = 0;
    }
} else {
    switchOxygen.checked = false;
    var switchOxygenPosition = 0;
    localStorage.setItem("Oxygen", switchOxygenPosition);
}
// labels
var switchOxygenYesLabel = document.getElementById("oxygen-yes-label")
var switchOxygenNoLabel = document.getElementById("oxygen-no-label")
...
sliderPassenger.noUiSlider.on('update', function(values, handle) {
    ...
    if (value > twoOccupantWeight) {
        ...
        switchBallastFrontLabel.style.fontWeight = "bold";
        switchBallastFrontLabel.style.color = "black";
        switchBallastRearLabel.style.fontWeight = "normal";
        switchBallastRearLabel.style.color = "grey";
        // move switch
        switchBallast.checked = false;
        switchBallastPosition = 1;


    } else {
        // move ballast to rear
        // change font size and color for the adviced value
        switchBallastRearLabel.style.fontWeight = "bold";
        switchBallastRearLabel.style.color = "black";
        switchBallastFrontLabel.style.fontWeight = "normal";
        switchBallastFrontLabel.style.color = "grey";
        // move switch
        switchBallast.checked = true;
        switchBallastPosition = 0;
    }
    updateFigure()
});
...
switchBallast.addEventListener('change', function() {
    if (switchBallast.checked) {
        ...
        switchBallastRearLabel.style.color = "black";
        switchBallastFrontLabel.style.fontWeight = "normal";
        switchBallastFrontLabel.style.color = style.getPropertyValue('--third');
        updateFigure()
    } else {
        switchBallastPosition = 1;
        switchBallastFrontLabel.style.fontWeight = "bold";
        switchBallastFrontLabel.style.color = "black";
        switchBallastRearLabel.style.fontWeight = "normal";
        switchBallastRearLabel.style.color = style.getPropertyValue('--third');
        updateFigure()
    }
});
...
switchOxygen.addEventListener('change', function() {
    ...
    if (switchOxygen.checked) {
        ...
        switchOxygenYesLabel.style.color = "black";
        switchOxygenNoLabel.style.fontWeight = "normal";
        switchOxygenNoLabel.style.color = style.getPropertyValue('--third');
        localStorage.setItem("Oxygen", switchOxygenPosition);
        updateFigure()
    } else {
        switchOxygenPosition = 0;
        switchOxygenNoLabel.style.fontWeight = "bold";
        switchOxygenNoLabel.style.color = "black";
        switchOxygenYesLabel.style.fontWeight = "normal";
        switchOxygenYesLabel.style.color = style.getPropertyValue('--third');
        localStorage.setItem("Oxygen", switchOxygenPosition);
        updateFigure()
    }
});